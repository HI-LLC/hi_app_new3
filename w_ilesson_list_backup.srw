$PBExportHeader$w_ilesson_list_backup.srw
forward
global type w_ilesson_list_backup from w_sheet
end type
type cb_3 from commandbutton within w_ilesson_list_backup
end type
type cb_2 from commandbutton within w_ilesson_list_backup
end type
type cb_1 from commandbutton within w_ilesson_list_backup
end type
type cb_close from commandbutton within w_ilesson_list_backup
end type
type cb_play_lesson from commandbutton within w_ilesson_list_backup
end type
type tv_1 from treeview within w_ilesson_list_backup
end type
end forward
...
global w_ilesson_list_backup w_ilesson_list_backup
...
on w_ilesson_list_backup.create
int iCurrent
call super::create
...
on w_ilesson_list_backup.destroy
call super::destroy
destroy(this.cb_3)
destroy(this.cb_2)
destroy(this.cb_1)
...
//istr_lesson_package.Package_prefix
//
//extExtractPackageFile(istr_lesson_package.Package_prefix, char *DestFile, long SourceInd) 
...
istr_lesson_package.Total_Lessons = 0
istr_lesson_package.Total_Resources = 0
extGetPkgHeader(ls_package_prefix, istr_lesson_package)
//MessageBox("Record_sig", istr_lesson_package.Record_sig)
//MessageBox("Package_prefix", istr_lesson_package.Package_prefix)
//MessageBox("Reserve", istr_lesson_package.Reserve)
//MessageBox("SystemID", istr_lesson_package.SystemID)
//MessageBox("Total_Lessons", string(istr_lesson_package.Total_Lessons))
//MessageBox("Total_Resources", string(istr_lesson_package.Total_Resources))
//MessageBox("Total_File_size", string(istr_lesson_package.Total_File_size))
