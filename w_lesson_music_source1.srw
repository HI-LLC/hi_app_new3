...
type p_2 from picture within w_lesson_music
end type
type p_3 from picture within w_lesson_music
end type
type p_4 from picture within w_lesson_music
end type
type p_5 from picture within w_lesson_music
end type
end forward
...
public function integer wf_get_rh_lh_note_list ();// function name: wf_get_rh_lh_note_list
...
extSetCurrentNote(ls_note_sent_to_keyboard) 
...
ll_dc = GetDC(il_win_handle)
//ll_x = UnitsToPixels(uo_1.uo_1.x, XUnitsToPixels!)
//ll_y = UnitsToPixels(p_keyboard1.y + p_keyboard1.height, YUnitsToPixels!)
...
//long ll_poly_x[] = {0, 20, 20,  0, 16, 16}
//long ll_poly_y[] = {0, 20, 16,  16, 0, 4}
//long  ll_point_counts[] = {3,3}
//
...
inv_forward_button.f_set_parms1(gl_lang_ind,ll_dc,ll_x,ll_y,ll_radius,ll_char_width,ll_char_height)
...
inv_backward_button.f_set_parms1(gl_lang_ind,ll_dc,ll_x,ll_y,ll_radius,ll_char_width,ll_char_height)
...
this.Control[iCurrent+27]=this.p_2
this.Control[iCurrent+28]=this.p_3
this.Control[iCurrent+29]=this.p_4
this.Control[iCurrent+30]=this.p_5
end on
...
event mousemove;call super::mousemove;//return

//sle_3.text = "x=" + string(xpos) + " y=" + string(ypos)
//
//if xpos > x + 10 and xpos < x + width - 10 and ypos > y + 10 and ypos < y + height - 10 then
if xpos > x + 10 and xpos < x + width - 10 and ypos > y + 10 and ypos < y + 40 then
	if Not ib_popup_menu and Not IsValid(iw_popup_menu) Then
		ib_popup_menu =  true
		open(iw_popup_menu, this)
	end if
...
ll_win_handle = handle(this)

ll_win_dc = GetDC(ll_win_handle)

CaptureImageRegion(ll_win_dc, "t1.bmp", ll_w,ll_h)
