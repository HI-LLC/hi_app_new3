$PBExportHeader$w_lesson_music_exe.srw
forward
global type w_lesson_music_exe from w_lesson
end type
type st_2 from statictext within w_lesson_music_exe
end type
type st_3 from statictext within w_lesson_music_exe
end type
type st_4 from statictext within w_lesson_music_exe
end type
type st_11 from statictext within w_lesson_music_exe
end type
type cb_start_record from commandbutton within w_lesson_music_exe
end type
type cb_play_demo from commandbutton within w_lesson_music_exe
end type
type cb_save from commandbutton within w_lesson_music_exe
end type
type cb_playback from commandbutton within w_lesson_music_exe
end type
type cbx_note_sound from checkbox within w_lesson_music_exe
end type
type pb_1 from picturebutton within w_lesson_music_exe
end type
type pb_2 from picturebutton within w_lesson_music_exe
end type
type cb_3 from commandbutton within w_lesson_music_exe
end type
type st_start from st_1 within w_lesson_music_exe
end type
type st_end from st_1 within w_lesson_music_exe
end type
type cbx_keyboard from checkbox within w_lesson_music_exe
end type
type sle_beat_rate from singlelineedit within w_lesson_music_exe
end type
type st_5 from statictext within w_lesson_music_exe
end type
type sle_1 from singlelineedit within w_lesson_music_exe
end type
type cb_1 from commandbutton within w_lesson_music_exe
end type
type pb_3 from picturebutton within w_lesson_music_exe
end type
type uo_1 from uo_music_sheet within w_lesson_music_exe
end type
type sle_2 from singlelineedit within w_lesson_music_exe
end type
type cbx_finger_hint from checkbox within w_lesson_music_exe
end type
type cb_2 from commandbutton within w_lesson_music_exe
end type
type cb_4 from commandbutton within w_lesson_music_exe
end type
end forward
...
global w_lesson_music_exe w_lesson_music_exe
...
type dw_reward from w_lesson`dw_reward within w_lesson_music_exe
end type

type cb_close from w_lesson`cb_close within w_lesson_music_exe
string tag = "1508040"
integer x = 4507
integer width = 210
integer height = 96
...
type cb_start from w_lesson`cb_start within w_lesson_music_exe
string tag = "1508040"
integer x = 4274
integer y = 20
integer width = 201
...
type dw_2 from w_lesson`dw_2 within w_lesson_music_exe
end type

type p_1 from w_lesson`p_1 within w_lesson_music_exe
...
type st_1 from w_lesson`st_1 within w_lesson_music_exe
integer x = 2085
integer y = 108
integer width = 73
integer height = 184
...
type dw_1 from w_lesson`dw_1 within w_lesson_music_exe
end type

type dw_prompt from w_lesson`dw_prompt within w_lesson_music_exe
integer x = 2939
integer width = 1120
