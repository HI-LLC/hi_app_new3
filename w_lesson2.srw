...
global type w_lesson2 from w_sheet
string tag = "1500000"
integer x = 823
integer y = 360
integer width = 3557
...
string ls_tmp, ls_resource_path, ls_data_col_ind
ib_prompt = false					
...
public subroutine wf_play_video (string as_video_file);OpenWithParm(w_play_avi, as_video_file, gn_appman.iw_frame)
...
public subroutine wf_dragdrop (dragobject source);w_lesson2 lw_tmp
integer li_count
integer li_y
...
type cb_close from commandbutton within w_lesson2
...
type cb_start from commandbutton within w_lesson2
event ue_paint pbm_paint
integer x = 2743
integer y = 12
integer width = 530
...
type dw_1 from datawindow within w_lesson2
...
type dw_2 from datawindow within w_lesson2
event key pbm_dwnkey
...
type p_1 from picture within w_lesson2
integer x = 23
integer y = 208
integer width = 325
integer height = 228
...
type st_1 from statictext within w_lesson2
