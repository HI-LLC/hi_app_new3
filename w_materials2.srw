$PBExportHeader$w_materials2.srw
forward
global type w_materials2 from w_sheet
end type
type ole_1 from olecontrol within w_materials2
end type
type tab_1 from tab within w_materials2
end type
...
type st_1 from statictext within w_materials2
end type
type st_2 from statictext within w_materials2
end type
type st_3 from statictext within w_materials2
end type
type st_4 from statictext within w_materials2
end type
type rr_1 from roundrectangle within w_materials2
end type
end forward
...
global w_materials2 w_materials2
...
public subroutine wf_time_text ();w_materials2 iw_window
if tab_1.Selectedtab <> ici_tbpg_rd then
	return
end if
...
string binarykey = "w_materials2.win"
