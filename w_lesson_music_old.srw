...
forward
global type w_lesson_music from w_lesson
end type
...
type pb_1 from picturebutton within w_lesson_music
end type
type pb_2 from picturebutton within w_lesson_music
end type
type cb_3 from commandbutton within w_lesson_music
end type
...
type uo_1 from uo_music_sheet within w_lesson_music
end type
...
type dw_reward from w_lesson`dw_reward within w_lesson_music
end type

type cb_close from w_lesson`cb_close within w_lesson_music
string tag = "1508040"
integer x = 4507
integer width = 210
integer height = 96
...
type cb_start from w_lesson`cb_start within w_lesson_music
string tag = "1508040"
integer x = 4274
integer y = 20
integer width = 201
...
type dw_2 from w_lesson`dw_2 within w_lesson_music
end type

type p_1 from w_lesson`p_1 within w_lesson_music
...
type st_1 from w_lesson`st_1 within w_lesson_music
integer x = 2085
integer y = 108
integer width = 73
integer height = 184
...
type dw_1 from w_lesson`dw_1 within w_lesson_music
end type

type dw_prompt from w_lesson`dw_prompt within w_lesson_music
integer x = 2939
integer width = 1120
